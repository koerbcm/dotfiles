# Generated by Powerlevel10k configuration wizard on 2021-08-10 at 13:37 MDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 41849.
# Wizard options: compatible, classic, ascii, light, 24h time, 2 lines, disconnected,
...
() {
  ...
  # Keep prompt stable with/without gitstatus fallback.
